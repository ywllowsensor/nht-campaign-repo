      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-12 right-0 rounded-full bg-neutral-800/50 p-2 text-xl text-background/50 ring-1 hover:brightness-70 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
                <XIcon className="size-5 text-white" />
              </motion.button>
              <div className="relative isolate z-1 size-full overflow-hidden rounded-2xl border-2 border-background/50 bg-black/80 shadow-lg shadow-black/50">
                <iframe
                  src={videoSrc}
