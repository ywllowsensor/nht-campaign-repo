      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-full bg-neutral-800/50 p-2 text-xl text-background/50 ring-1 hover:brightness-70 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
