...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute top-[1em] z-50 w-full left-0 md:w-auto md:left-auto">
      ...
      >
        {isRouterLink(items?.[0]?.href) ? (
          <Link
            ...
            className="rounded-full p-0.5 inline-flex items-center justify-center overflow-hidden shadow-xl"
            style={{
              width: 'var(--nav-h)',
              height: 'var(--nav-h)',
        ...
        <div
          ref={navItemsRef}
          className="relative items-center rounded-full hidden md:flex ml-2 shadow-xl"
          style={{
            height: 'var(--nav-h)',
            background: 'var(--base, #000)'
          }}
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute overflow-hidden top-[3em] left-4 right-4 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] z-998 origin-top"
        style={{
          ...cssVars,
